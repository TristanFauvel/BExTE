...
- [`SeparateGaussian$new()`](#method-SeparateGaussian-initialize)
...
- [`StaticBorrowingGaussian$vectorised_prior_variance()`](https://quinten-health-os.github.io/BayesianExtrapolationSimulation/reference/StaticBorrowingGaussian.html#method-vectorised_prior_variance)

------------------------------------------------------------------------

### `SeparateGaussian$new()`
