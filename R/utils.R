...
frequentist_col_types <- cols(
  ...
  interval_score = col_double(),
  conf_int_interval_score_lower = col_double(),
  conf_int_interval_score_upper = col_double(),
...
results_columns <- c("success_proba", "mcse_success_proba", "conf_int_success_proba_lower",
                     ...
                     "conf_int_precision_lower", "conf_int_precision_upper", "interval_score",
...
expected_colnames_results <- c(
  ...
  "interval_score",
  "conf_int_interval_score_lower",
  "conf_int_interval_score_upper",
  "credible_interval_lower",
...
format_simulation_output_table <- function(output) {
  ...
  data <- list(
    ...
    "Interval Score" = c(
      output$interval_score,
      output$conf_int_interval_score_lower,
      output$conf_int_interval_score_upper
    ),
    "Credible Interval" = c(
      NA,
